...
--spld "/hpc/compgen/users/cchang/Projects/gene_exp_VAE/data/SyNet_fold_6.csv"  \
--conf 'conf41' \
--cvbs 'fold6_tanh_scale1_512_loss_scaler_absx1' \
--sdp "/hpc/compgen/users/cchang/Projects/gene_exp_VAE/data/new0418/trained_model_state_dict/best_models/state_dict_conf41_fold6_tanh_scale1_512_loss_scaler_absx1_epoch358.pt" \
--tebs 128 \
--first 512 \
--second 256 \
--third 128 \
