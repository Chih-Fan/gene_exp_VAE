...
--spld "/hpc/compgen/users/cchang/Projects/gene_exp_VAE/data/SyNet_fold_3.csv"  \
--conf 'conf41' \
--cvbs 'fold3_tanh_scale1_512_loss_scaler_absx1' \
--sdp "/hpc/compgen/users/cchang/Projects/gene_exp_VAE/data/new0418/trained_model_state_dict/best_models/state_dict_conf41_fold3_tanh_scale1_512_loss_scaler_absx1_epoch310.pt" \
--tebs 256 \
--first 512 \
--second 256 \
--third 128 \
