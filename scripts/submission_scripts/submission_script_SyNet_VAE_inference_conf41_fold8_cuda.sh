...
--spld "/hpc/compgen/users/cchang/Projects/gene_exp_VAE/data/SyNet_fold_8.csv"  \
--conf 'conf41' \
--cvbs 'fold8_tanh_scale1_512_loss_scaler_absx1' \
--sdp "/hpc/compgen/users/cchang/Projects/gene_exp_VAE/data/new0418/trained_model_state_dict/best_models/state_dict_conf41_fold8_tanh_scale1_512_loss_scaler_absx1_epoch366.pt" \
--tebs 32 \
--first 512 \
--second 256 \
--third 128 \
