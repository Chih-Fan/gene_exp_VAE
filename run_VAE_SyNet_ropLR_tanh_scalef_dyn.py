...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, x in enumerate(train_dataloader):  # How does the train_dataloader look like? We don't have labels. 
            ...
            train_reconstruction_loss, train_loss = model.loss_function(pred=x_r, target=x, mean=mu, log_var=log_var)
        ...
        with torch.no_grad():
            ...
            for batch_idx, x in enumerate(train_dataloader):  
                ...
                z, mu, log_var, x_r= model(x)
                train_reconstruction_loss_corrected, train_loss_corrected = model.loss_function(pred=x_r, target=x, mean=mu, log_var=log_var)
            ...
            for batch_idx, x in enumerate(val_dataloader):
                ...
                z, mu, log_var, x_r= model(x)
                val_reconstruction_loss, val_loss = model.loss_function(pred=x_r, target=x, mean=mu, log_var=log_var)
